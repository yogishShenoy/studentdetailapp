...
class log_lecturer extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: lecturer_log_page(),
    );
  }
}

class lecturer_log_page extends StatefulWidget {
  @override
  _admin_log_pageState createState() => _admin_log_pageState();
}

class _admin_log_pageState extends State<lecturer_log_page> {
  next() {
    Navigator.of(context).pop();
    Navigator.of(context).pushNamed("logged_lecturer");
  }
